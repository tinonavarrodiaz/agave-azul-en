...
isMobile.mobilecheck() ? body.classList.add('mobile') :  body.classList.add('desktop')
...
if (headerEl && sections && footerEl) menuAction(headerEl, sections, footerEl, isMobile.mobilecheck())
